...
|---------------------------|----------------------------------|---------|
| Jelly Forest v1.2.2       | Mint green input, strawberry buttons, tooltip bubbles | [🖌 Install](https://userstyles.world/style/21808/chino-jelly-forest) |
...
| 主题名                        | 简介                                     | 安装 |
|------------------------------|------------------------------------------|------|
| 🌿 Chino 果冻森林 Jelly Forest v1.2.2 | 抹茶输入框 + 粉色按钮 + 薄荷 code + 气泡提示 | [点此安装](https://userstyles.world/style/21808/chino-jelly-forest) |
